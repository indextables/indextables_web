...
<dependency>
  ...
  <version>0.5.2_spark_3.5.3</version>
...
```scala
libraryDependencies += "io.indextables" % "indextables_spark" % "0.5.2_spark_3.5.3" classifier "linux-x86_64-shaded"
```

## Spark Shell

```bash
spark-shell --packages io.indextables:indextables_spark:0.5.2_spark_3.5.3:linux-x86_64-shaded
```
